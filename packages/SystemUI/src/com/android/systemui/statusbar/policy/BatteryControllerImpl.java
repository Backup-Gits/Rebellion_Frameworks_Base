...
public class BatteryControllerImpl extends BroadcastReceiver implements BatteryController {
    ...
    private void deviceSpecificPerfermanceModeHandler(boolean enabled) {
        if(enabled && Utils.IntelligentPerformanceProfileAvailable()) {
            Utils.SetLastPerformanceProfileToSettings(mContext, SystemProperties.get(SPECTRUM_SYSTEM_PROPERTY, Resources.getSystem().getString(R.string.config_balanced_profile)));
            SystemProperties.set(SPECTRUM_SYSTEM_PROPERTY, Resources.getSystem().getString(R.string.config_powersave_profile));
        } else {
            SystemProperties.set(SPECTRUM_SYSTEM_PROPERTY, Utils.GetLastPerformanceProfileFromSettings(mContext));
        }
    }

...
public class NavigationModeController implements Dumpable {
    ...
    private final class NavSettingsObserver extends ContentObserver {
        public NavSettingsObserver(Handler handler) {
            super(handler);
        }
    ...
    private NavSettingsObserver mSettingsObserver;
    ...
    public NavigationModeController(Context context,
        ...
        mSettingsObserver = new NavSettingsObserver(new Handler());

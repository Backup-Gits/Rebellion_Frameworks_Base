...
public class CollapsedStatusBarFragment extends Fragment implements CommandQueue.Callbacks,
    ...
    private ImageView mRebellionLogo;
    private ImageView mRebellionLogoRight;
	...
	mRebellionLogo = mStatusBar.findViewById(R.id.status_bar_logo);
	mRebellionLogoRight = mStatusBar.findViewById(R.id.status_bar_logo_right);
    ...
    public void hideSystemIconArea(boolean animate) {
        ...
        if (mShowLogo == 2) {
            animateHide(mRebellionLogoRight, animate, false);
        }
    ...
    public void showSystemIconArea(boolean animate) {
        ...
        if (mShowLogo == 2) {
            animateShow(mRebellionLogoRight, animate);
        }
        for (View batteryBar: mBatteryBars) {
...
*/
	...
	animateHide(mCenterClockLayout, animate, true);
        if (mShowLogo == 1) {
            animateHide(mRebellionLogo, animate, false);
        }
    }
    ...
    public void showNotificationIconArea(boolean animate) {
        ...
        animateShow(mCenterClockLayout, animate);
         if (mShowLogo == 1) {
             animateShow(mRebellionLogo, animate);
         }
    }
    ...
    public void updateLogoSettings(boolean animate) {
        ...
        switch(mLogoStyle) {
                // WolF Logo
            case 1:
                logo = getContext().getDrawable(R.drawable.ic_wolf_logo);
                break;
                // Cannabis
            case 2:
                logo = getContext().getDrawable(R.drawable.ic_cannabis_logo);
                break;
                // GZR Skull
            case 3:
            ...
            case 33:
                ...
                break;
            case 34:
                logo = getContext().getDrawable(R.drawable.ic_rebel_pheonix);
                break;
                // Default (Rebellion Main)
            case 0:
            default:
        ...
        if (mShowLogo == 1) {
	    mRebellionLogo.setImageDrawable(null);
	    mRebellionLogo.setImageDrawable(logo);
 	    mRebellionLogo.setColorFilter(mLogoColor, PorterDuff.Mode.MULTIPLY);
	} else if (mShowLogo == 2) {
	    mRebellionLogoRight.setImageDrawable(null);
	    mRebellionLogoRight.setImageDrawable(logo);
	    mRebellionLogoRight.setColorFilter(mLogoColor, PorterDuff.Mode.MULTIPLY);
	}

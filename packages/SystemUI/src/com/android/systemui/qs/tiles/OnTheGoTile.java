...
import com.android.internal.util.rebellion.OnTheGoActions;
import com.android.internal.util.rebellion.OnTheGoUtils;
...
public class OnTheGoTile extends QSTileImpl<BooleanState> {
    ...
    private static final String SERVICE_NAME = "com.android.systemui.rebellion.onthego.OnTheGoService";
    ...
    protected void toggleState() {
        Intent service = (new Intent())
                ...
                "com.android.systemui.rebellion.onthego.OnTheGoService");
    ...
    protected void handleUpdateState(BooleanState state, Object arg) {
        ...
        state.value = Utils.isServiceRunning(mContext, SERVICE_NAME);
